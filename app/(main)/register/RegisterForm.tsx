  ...
  return (
    <form action={handleSubmit} className="flex flex-col gap-lg w-full">
      ...
      <div className="flex flex-col gap-xs group">
        <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider group-focus-within:text-secondary transition-colors duration-300">Codename</label>
        <input 
          name="name"
          type="text" 
          required
      ...
      <div className="flex flex-col gap-xs group">
        <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider group-focus-within:text-secondary transition-colors duration-300">Email</label>
        <input 
          name="email"
          type="email" 
          required
      ...
      <div className="flex flex-col gap-xs group">
        <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider group-focus-within:text-secondary transition-colors duration-300">Password</label>
        <input 
          name="password"
          type="password" 
          required
      ...
      <p className="text-center text-sm text-on-surface-variant mt-sm">
        Already registered? <Link href="/login" className="text-secondary font-semibold hover:text-white hover:underline transition-colors duration-300">Access Terminal</Link>
      </p>
    </form>
  );
}
