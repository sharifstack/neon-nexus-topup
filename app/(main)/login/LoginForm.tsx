  ...
  return (
    <form action={handleSubmit} className="flex flex-col gap-lg w-full">
      ...
      <div className="flex flex-col gap-xs group">
        <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider group-focus-within:text-primary transition-colors duration-300">Email</label>
        <input 
          name="email"
          type="email" 
          required
      ...
      <div className="flex flex-col gap-xs group">
        <label className="font-label-sm text-label-sm text-on-surface-variant uppercase tracking-wider group-focus-within:text-primary transition-colors duration-300">Password</label>
        <input 
          name="password"
          type="password" 
          required
      ...
      <p className="text-center text-sm text-on-surface-variant mt-sm">
        Need clearance? <Link href="/register" className="text-primary font-semibold hover:text-white hover:underline transition-colors duration-300">Register here</Link>
      </p>
    </form>
  );
}
